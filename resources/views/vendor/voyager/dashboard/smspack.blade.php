...
<div class="smspack">
    ...
    <div class="box">
        <ul>
            <li>{{__('hotdesk.smspack_qu')}}
                <span>{{Auth::user()->locale == 'fa' ? fa_number($smsdata->stock) : $smsdata->stock}} {{__('hotdesk.smspack_sms')}}</span>
            </li>
            <li>{{__('hotdesk.smspack_sends')}}
                <span>{{Auth::user()->locale == 'fa' ? fa_number($smsdata->sends) : $smsdata->sends}} {{__('hotdesk.smspack_sms')}}</span>
            </li>
            <li>{{__('hotdesk.smspack_totalsends')}}
                <span>{{Auth::user()->locale == 'fa' ? fa_number($smsdata->totalsend) : $smsdata->totalsend}} {{__('hotdesk.smspack_sms')}}</span>
            </li>
        </ul>
        <div class="actions">
